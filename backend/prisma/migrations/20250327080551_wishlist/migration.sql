...
-- AddForeignKey
ALTER TABLE `InventorySupplier` ADD CONSTRAINT `InventorySupplier_inventoryId_fkey` FOREIGN KEY (`inventoryId`) REFERENCES `Inventory`(`productId`) ON DELETE RESTRICT ON UPDATE CASCADE;
